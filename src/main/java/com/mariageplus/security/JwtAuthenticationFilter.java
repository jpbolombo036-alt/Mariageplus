...
/**
 * Filtre d'authentification : valide le JWT puis recharge le principal depuis
 * la base (rôles / permissions / organisation à jour, refus d'un compte désactivé).
 */
@Component
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
            try {
                ...
                log.warn("Authentification refusée (token invalide ou compte inactif) pour {}", request.getRequestURI());
                SecurityContextHolder.clearContext();
            }
        }
